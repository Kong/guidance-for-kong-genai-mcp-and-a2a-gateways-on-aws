...
Create the new Agent directory structure
```
agentcore create --name agentcorekong --defaults
```
...
Agents
  kongagentcore: Deployed - Runtime: READY (arn:aws:bedrock-agentcore:us-east-2:481711488351:runtime/kongagentcore_kongagentcore-IcMtukH94z)
  URL: https://bedrock-agentcore.us-east-2.amazonaws.com/runtimes/arn%3Aaws%3Abedrock-agentcore%3Aus-east-2%3A481711488351%3Aruntime%2Fkongagentcore_kongagentcore-IcMtukH94z/invocations
