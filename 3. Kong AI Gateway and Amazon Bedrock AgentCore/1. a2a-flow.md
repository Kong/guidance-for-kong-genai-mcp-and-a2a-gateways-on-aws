...
As described in the Card, the Agent has only one SKill. If you send a request you should be able to see a response:
  ...
  }' | jq
{
  "result": {
    "task": {
      "id": "d562894e-60be-4093-8c02-c26ea2957053",
      "contextId": "30725944-e4b5-45d7-b137-4097132eb852",
      "status": {
        "state": "TASK_STATE_COMPLETED",
        "timestamp": "2026-05-26T21:26:37.099804Z"
      },
      "artifacts": [
        {
          "artifactId": "02c1b78c-58f6-458a-8dd7-0559595b0ff9",
          "name": "result",
          "parts": [
            {
              "text": "that's the response"
      ...
      "history": [
        {
          "messageId": "msg-001",
          "contextId": "30725944-e4b5-45d7-b137-4097132eb852",
          "taskId": "d562894e-60be-4093-8c02-c26ea2957053",
          "role": "ROLE_USER",
          "parts": [
            {
              "text": "How much is 100 USD in EUR?"
...
awscurl \
  ...
  --region us-west-2 \
  $AGENTCORE_URL/.well-known/agent-card.json
```
